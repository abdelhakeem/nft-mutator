...
const Navbar = () => {
    ...
    return (
        <div className="drawer w-full">
            ...
            <div className="flex drawer-content w-full justify-between h-20 px-16" style={{overflow: "visible"}}>
                <a className="relative w-1/3 md:w-[15%]">
                    <Image src="/NFTMutator_logo.svg" layout="fill"></Image>
                </a>
                <div className="justify-center gap-16 items-center wallet-button-parent hidden md:flex">
